...
export function UserProfileModal({
  ...
  useEffect(() => {
    ...
    logger.debug('Modal opened, partner data', {
  ...
  const handleShare = async (): Promise<void> => {
    try {
      const profileUrl = `${window.location.origin}/profile/${partner.username}`;
      await navigator.clipboard.writeText(profileUrl);
      setIsSharing(true);
      setTimeout(() => setIsSharing(false), 2000);
    } catch (err) {
      logger.error('Error sharing profile', { error: err });
    }
  };
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full mx-4 overflow-hidden animate-scale-in max-h-[95vh] flex flex-col">
                ...
                <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                    <div className="flex items-start gap-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-4 w-4 text-primary-600 dark:text-primary-400 mt-0.5 flex-shrink-0"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-br from-pink-50 to-rose-100 dark:from-pink-900/30 dark:to-rose-800/30 rounded-lg p-3 border border-pink-200 dark:border-pink-700 shadow-sm">
                      <div className="flex items-center gap-2">
                        <div className="rounded-lg p-1.5 bg-pink-500 dark:bg-pink-600">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {stats.badges.map((badge) => (
                          <div
                            key={badge.id}
                            className="bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-800/30 rounded-lg p-2 border border-purple-200 dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow group relative"
        ...
        {/* Footer with Actions */}
        <div className="px-4 sm:px-6 py-3 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
